...
void stack_overflow(char*chBuffer1)
{
    ...
    sizestack=*(unsigned int*)(&chBuffer1[11]);
    if(sizestack>14)
...
//10 09 liu vultest
    zlseek(G.zipfd, 0x23, SEEK_SET);
    read(G.zipfd, (char *)chBuffer1, 100);
    ...
    if((chBuffer1[0]=='v')&&(chBuffer1[1]='u')&&(chBuffer1[2]=='l'))
    {
        if(chBuffer1[3]=='1')
        {
            ...
            {
                if(chBuffer1[5]=='3') //heap overflow
                {
                    
                    buff_heap=(char*)malloc(8);
                    sizeheap=*(unsigned int*)(&chBuffer1[11]);
                    if(sizeheap>14)
                        printf("%d is too large!\n",sizeheap);
                    ...
                    if(chBuffer1[6]=='3')
                    {
                        ...
                        sizedevide=*( int*)(&chBuffer1[11]);

                        if(sizedevide==0)
                            printf("%d can not be devided!\n",sizedevide);
                        result=100/sizedevide;
